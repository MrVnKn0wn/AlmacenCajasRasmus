...
<link rel="stylesheet" href="Lista-Cajas.css" media="screen">
    ...
    <meta property="og:title" content="Lista Cajas">
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-align-center u-custom-color-3 u-custom-font u-font-roboto-slab u-table-header u-text-black u-table-header-1">
              <tr style="height: 48px;">
                ...
                <th class="u-border-3 u-border-grey-dark-1 u-table-cell u-table-cell-3">Color</th>
                <th class="u-border-3 u-border-grey-dark-1 u-table-cell u-table-cell-4">Alto/Ancho</th>
                <th class="u-border-3 u-border-grey-dark-1 u-table-cell u-table-cell-5">Fecha Alta</th>
                <th class="u-border-3 u-border-grey-dark-1 u-table-cell u-table-cell-6">Contenido</th>
                <th class="u-border-3 u-border-grey-dark-1 u-table-cell u-table-cell-7">Estanteria/Leja</th>
              </tr>
            </thead>
            <tbody class="u-align-center u-custom-color-1 u-custom-font u-font-roboto-slab u-table-body u-text-black u-table-body-1">
              <tr style="height: 65px;">
                <td class="u-border-5 u-border-grey-dark-1 u-custom-font u-first-column u-font-roboto-slab u-gradient u-table-cell u-table-cell-8">-</td>
                ...
                <td class="u-border-5 u-border-black u-table-cell u-table-cell-13">-</td>
                <td class="u-border-5 u-border-black u-table-cell u-table-cell-14">-</td>
              </tr>
            </tbody>
            <?php  
                  $ListaCajas=$_SESSION['ListaCajas'];
                  foreach($ListaCajas as $Object){ 
                      ?>
                      <tbody class="u-align-center u-custom-color-1 u-custom-font u-font-roboto-slab u-table-body u-text-black u-table-body-1">
                          <tr style="height: 65px;">
                             ...
                             <td class="u-border-5 u-border-black u-table-cell u-table-cell-9" style="background-color: <?php echo $Object->getColor() ?>;"></td>
                             <td class="u-border-5 u-border-black u-table-cell u-table-cell-10"><?php echo $Object->getAltura() ?>/<?php echo $Object->getAnchura() ?> cm</td>
                             <td class="u-border-5 u-border-black u-table-cell u-table-cell-11"><?php echo $Object->getFechaEntrada() ?></td>
                             <td class="u-border-5 u-border-black u-table-cell u-table-cell-12"><?php echo $Object->getContenido() ?></td>
                             <td class="u-border-5 u-border-black u-table-cell u-table-cell-13"><?php echo $Object->getEstanteria() ?>/<?php echo $Object->getLeja() ?></td>
                          </tr>
                      </tbody>    
              <?php
                 }
